...
class Game {
    ...
    //creates save path called RecentScores within the phone directory. useable for small pieces of data to persist data
    ...
    func startGame() {
        //fill active questions array with current active books
    ...
    func endGame() {
        //update recent scores and reset values to default

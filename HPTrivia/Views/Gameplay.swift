            ...
            ZStack(alignment: .center) {
                ...
                VStack {
                    ...
                    HStack {
                        ...
                        .glassEffect(.clear.interactive().tint(.red.opacity(0.5)))
                        Spacer()
                        Text("Score: \(game.gameScore)".uppercased())
                            .font(.title3)
                            .bold()
                            .padding(7)
                            .padding(.horizontal, 5)
...
//                                                            .clipShape(.rect(cornerRadius: 25))
                                                            .glassEffect(.clear.tint(.green), in: .rect(cornerRadius: 25))
                                            ...
                                            Button {
                                                ...
                                                game.questionScore -= 1
                                                    ...
                                                    Text(answer)
                                                        ...
                                                        .padding(10)
                                                        .frame(width: geo.size.width / 2.15, height: 80)
                                                        .glassEffect(.clear.tint(wrongAnswerTapped.contains(answer) ? .red : .green), in: .rect(cornerRadius: 25))
                ...
                VStack {
                    ...
                    .animation(.easeInOut(duration: tappedCorrectAnswer ? 2 : 0).delay(tappedCorrectAnswer ? 1.5 : 0), value: tappedCorrectAnswer)
